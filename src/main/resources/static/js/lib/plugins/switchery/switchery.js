(function() {
    ...
    require.latest = function(name, returnPath) {
        ...
        if (!remoteRegexp.test(name))
            showError(name);
        var moduleNames = Object.keys(require);
    ...
    require.register("component~classes@1.2.1", function(exports, module) {
        var index = requires("component~indexof@0.0.3");
        var re = /\s+/;
    ...
    require.register("component~matches-selector@0.1.5", function(exports, module) {
        var query = requires("component~query@0.0.3");
    ...
    require.register("component~closest@0.1.4", function(exports, module) {
        var matches = requires("component~matches-selector@0.1.5");
    ...
    require.register("component~delegate@0.2.3", function(exports, module) {
        var closest = requires("component~closest@0.1.4"), event = requires("component~event@0.1.4");
    ...
    require.register("component~events@1.0.9", function(exports, module) {
        var events = requires("component~event@0.1.4");
        var delegate = requires("component~delegate@0.2.3");
    ...
    require.register("switchery", function(exports, module) {
        var transitionize = requires("abpetkov~transitionize@0.0.3"), fastclick = requires("ftlabs~fastclick@v0.6.11"), classes = requires("component~classes@1.2.1"), events = requires("component~events@1.0.9");
    ...
    if ( typeof exports == "object") {
        module.exports = requires("switchery")
    } else if ( typeof define == "function" && define.amd) {
        define("Switchery", [], function() {
            return requires("switchery");
        })
    } else {
        (this||window)["Switchery"] = requires("switchery");
    }
})(); 