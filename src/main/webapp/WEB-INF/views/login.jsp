...
<div class="container demo-1">
    <div class="content">
        <div id="large-header" class="large-header" style="height: 667px;">
            ...
            <div class="logo_box">
                <h6>欢迎加入：这里有你需要的一切，同时我们也在努力完善中...</h6>
                ...
                <form action="/login" id="form1" method="post">
                    ...
                    <div class="mb2">
                        <a class="act-but submit" onclick="document.getElementById('form1').submit(); "
                                        style="color: #FFFFFF">登录</a>
                        <a class="act-but submit" href="/register"
                                        style="color: #FFFFFF;margin-left: 185px">注册</a>
