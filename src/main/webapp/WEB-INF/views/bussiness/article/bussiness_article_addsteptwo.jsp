                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control required" id="customId" maxlength="255"
                                               type="hidden"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label class="radio-inline">
                                    <input type="radio" class="required" maxlength="255" autocomplete="off" name="type1"
                                           value="1" seq="1"/>原稿
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" class="required" maxlength="255" autocomplete="off" name="type1"
                                           value="2" checked="true" seq="1"/>连接
                                </label>
                                <span class="glyphicon  form-control-feedback" aria-hidden="true"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
    require(['jquery', 'bootstrap', 'jqueryValidateMessages'], function ($) {
        require(['Chosen', 'toastr', 'suggest', 'sys', 'sweetalert'], function () {
            //选择框赋值
            $("select").chosen();
