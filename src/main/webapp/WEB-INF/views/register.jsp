    ...
    <div class="content">
        <div id="large-header" class="large-header" style="height: 667px;">
            ...
            <div class="logo_box">
                ...
                <form action="/register/save" id="form1" method="post">
                    ...
                    <div class="input_outer">
                        ...
                        <input name="loginName" autocomplete="off" class="text"
                               style="color: #FFFFFF !important; position:absolute; z-index:100;" value=""
                               type="loginName" placeholder="登录账号">
                    </div>
                    <input style="display:none">
                    <div class="input_outer">
                        <span class="us_uer"></span>
                    ...
                    <div class="mb2">
                        <a class="act-but register" onclick="document.getElementById('form1').submit(); "
